...
def create_placeholder_image(text="Placeholder Image", output_path="placeholder.png"):
    """Create a more visually appealing placeholder image with the given text."""
    ...
    try:
        # Try to find a font on the system, or fall back to default
        font_path = None
        ...
        if font_path:
            ...
            # Use default font if no font files are found
    ...
    for line in lines:
        ...
        draw.text((subtitle_x, y_offset), line, fill=(200, 200, 255), font=subtitle_font)
        y_offset += 30
    
    # Add website info
    footer_text = "text-to-3d-nextjs.vercel.app"
    footer_font = subtitle_font
    footer_bbox = draw.textbbox((0, 0), footer_text, font=footer_font)
    footer_width = footer_bbox[2] - footer_bbox[0]
    footer_x = (512 - footer_width) // 2
    draw.text((footer_x, 450), footer_text, fill=(180, 180, 220), font=footer_font)
...
if __name__ == "__main__":
    # When run directly, create a default placeholder
    create_placeholder_image("No image could be generated for this prompt. Please try again.")
